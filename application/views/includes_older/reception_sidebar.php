<div class="sidebar sidebar-fixed">
        ...
        <div class="sidebar-inner">
            ...
            <ul class="navi">
                ...
                <li class="current"><a href="<?php echo site_url();?>/reception"><i class="icon-list"></i>Reception Dashboard</a></li>
                ...
                <!-- Menu with sub menu -->
                <li><a href="<?php echo site_url();?>/reception/all-patients"> <i class="icon-list"></i> Patients List</a></li>
