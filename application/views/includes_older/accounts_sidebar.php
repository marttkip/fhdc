<div class="sidebar sidebar-fixed">
        ...
        <div class="sidebar-inner">
            ...
            <ul class="navi">
                ...
                <li class="current"><a href="<?php echo site_url();?>/accounts"><i class="icon-list"></i>Accounts Dashboard</a></li>
                ...
                <li class="has_submenu">
                 ...
                 <li class="has_submenu">
                    ...
                    <ul>
                        <li class="current"><a href="<?php echo site_url();?>/administration/expenses/accounts"><i class="icon-list"></i> Expenses</a></li>
                        <li class="current"><a href="<?php echo site_url();?>/administration/suppliers/accounts"><i class="icon-list"></i> Suppliers</a></li>
