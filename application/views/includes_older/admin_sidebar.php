<div class="sidebar sidebar-fixed">
        ...
        <div class="sidebar-inner">
            ...
            <ul class="navi">
                ...
                <li class="current"><a href="<?php echo site_url();?>/administration"><i class="icon-list"></i>Admin Dashboard</a></li>
               ...
               <li class="has_submenu">
                    ...
                    <ul>
                        <li class="current"><a href="<?php echo site_url();?>/administration/patient_statement"><i class="icon-list"></i> Patients Accounts</a></li>
                ...
                <!-- Menu with sub menu -->
             	<li class="has_submenu">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo site_url();?>/administration/all-insuarance-company">Insurance Companies</a></li>
