                        ...
                        <div class="col-md-12">
                            <div class="col-md-7">
                              ...
                              <div class="col-md-5">
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      <div class="center-align">
                                         <span class="bold">Choose mode : </span> <input type="radio" name="choose_mode" value="1" checked="checked" onclick="getmode(1)">Add payment
                                          <input type="radio" name="choose_mode" value="2" onclick="getmode(2)"> Add billing info
                                        </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <!-- Bill Methods -->
                                <div class="row" id="billing_info_div" style="display:none">
                                    <div class="col-md-12">
                                                          ...
                                                          <option value="Select Billing Method">--- Select Billing Method ---</option>
                                                             ...
                                                             if($billing_methods->num_rows > 0)
                                                             {
                                                                ...
                                                                foreach($methods as $res)
                                                                {
                                                                  ...
                                                                  if($insurance_company == $insurance_company_id)
                                                                  {
...
<script type="text/javascript">
  ...
  function getmode(id){
        ...
        var myTarget1 = document.getElementById("payment_div");
        var myTarget2 = document.getElementById("billing_info_div");
