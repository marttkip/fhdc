			...
			foreach ($query->result() as $row)
			{
						...
						$todays_new_notes .= '
						                	<div class="col-md-12">
							                	<div class="form-group">
							                		...
							                		<div class="col-lg-10">
														<textarea id="hpco'.$visit_id.'" name="hpco'.$visit_id1.'" rows="4" cols="50" class="form-control col-md-6" >'.$hpco.'</textarea>
													</div>
												</div>
											</div>
										';
				...
				if($visit_id == $visit_id1 && $number_items > 1 && $count == $number_items)
				{
					...
					// this should only include the small additional notes text area
						...
						$notes = $todays_notes;
						$item_to_display2 = '<textarea id="todays_notes'.$visit_id.'" name="todays_notes'.$visit_id.'" rows="5" cols="50" class="form-control col-md-6" >'.$notes.'</textarea>';
