	                        ...
	                        <div class="padd">
			                	<div class="col-md-12">
				                	<div class="form-group">
				                		<div class="col-lg-12">
											<textarea id="hpco" rows="4" cols="50" class="form-control col-md-6" >'.$hpco.'</textarea>
										</div>
									</div>
								</div>
	                    ...
	                    <div class="widget-content">
	                        <div class="padd">
			                	<div class="col-md-12">
				                	<div class="form-group">
				                		<div class="col-lg-12">
											<textarea id="hpco" rows="4" cols="50" class="form-control col-md-6" ></textarea>
										</div>
									</div>
								</div>
	                        ...
	                        <div class="padd">
			                	<div class="col-md-12">
				                	<div class="form-group">
				                		...
				                		<div class="col-lg-10">
											<textarea id="past_dental_hx" rows="4" cols="50" class="form-control col-md-6" >'.$past_dental_history.'</textarea>
										</div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea id="past_medical_hx" rows="4" cols="50" class="form-control col-md-6" >'.$past_medical_history.'</textarea>
										</div>
									</div>
								</div>
	                        ...
	                        <div class="padd">
			                	<div class="col-md-12">
				                	<div class="form-group">
				                		<label class="col-lg-2 control-label">PD Hx : </label>
				                		<div class="col-lg-10">
											<textarea id="past_dental_hx" rows="4" cols="50" class="form-control col-md-6" ></textarea>
										</div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
				                		<label class="col-lg-2 control-label">PM Hx : </label>
										<div class="col-lg-10">
											<textarea id="past_medical_hx" rows="4" cols="50" class="form-control col-md-6" ></textarea>
										</div>
									</div>
								</div>
	                        ...
	                        <div class="padd">
			                	<div class="col-md-12">
				                	<div class="form-group">
				                		...
				                		<div class="col-lg-10">
											<textarea id="soft_tissue" rows="4" cols="50" class="form-control col-md-6" >'.$soft_tissue.'</textarea>
										</div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
				                		...
				                		<div class="col-md-10">
				                			<div class="col-md-12">
												...
												<div class="col-lg-10">
													<textarea id="general" rows="4" cols="50" class="form-control col-md-6" >'.$general.'</textarea>
												</div>
											</div>
				                			<div class="col-md-12">
					                			<label class="col-lg-2 control-label">Decayed : </label>
												<div class="col-lg-10">
													<textarea id="decayed" rows="4" cols="50" class="form-control col-md-6" >'.$decayed.'</textarea>
												</div>
											</div>
											<div class="col-md-12">
												<label class="col-lg-2 control-label">Missing : </label>
												<div class="col-lg-10">
													<textarea id="missing" rows="4" cols="50" class="form-control col-md-6" >'.$missing.'</textarea>
												</div>
											</div>
											<div class="col-md-12">
												<label class="col-lg-2 control-label">Filled : </label>
												<div class="col-lg-10">
													<textarea id="filled" rows="4" cols="50" class="form-control col-md-6" >'.$filled.'</textarea>
												</div>
											</div>
											<div class="col-md-12">
					                			<label class="col-lg-2 control-label">Others : </label>
												<div class="col-lg-10">
													<textarea id="others" rows="4" cols="50" class="form-control col-md-6" >'.$decayed.'</textarea>
												</div>
											</div>
										</div>
									</div>
	                        ...
	                        <div class="padd">
			                	<div class="col-md-12">
				                	<div class="form-group">
				                		<label class="col-lg-2 control-label">Soft Tissue : </label>
				                		<div class="col-lg-10">
											<textarea id="soft_tissue" rows="4" cols="50" class="form-control col-md-6" ></textarea>
										</div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
				                		<label class="col-lg-2 control-label">Hard Tissue : </label>
				                		<div class="col-md-10">
				                					<textarea id="general" rows="4" cols="50" class="form-control col-md-12" placeholder="General Information"></textarea>
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-10">
											<textarea id="decayed" rows="4" cols="50" class="form-control col-md-6" placeholder="Decayed Information"></textarea>
										</div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
				                		<label class="col-lg-2 control-label"> </label>
										<div class="col-lg-10">
											<textarea id="missing" rows="4" cols="50" class="form-control col-md-6" placeholder="Missing information"></textarea>
										</div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
				                		<label class="col-lg-2 control-label"> </label>
										<div class="col-lg-10">
											<textarea id="filled" rows="4" cols="50" class="form-control col-md-6" placeholder="Filled Information"></textarea>
										</div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
				                		<label class="col-lg-2 control-label"> </label>
											<div class="col-lg-10">
												<textarea id="others" rows="4" cols="50" class="form-control col-md-6" placeholder="Other Information"></textarea>
											</div>
	                    ...
	                    <div class="widget-content">
	                        <div class="padd">
								<div class="col-md-12">
									<div class="form-group">
										<div class="col-lg-12">
											<textarea id="investigations" rows="4" cols="50" class="form-control col-md-6" >'.$investigation.'</textarea>
										</div>
									</div>
								</div>
							</div>
	                    ...
	                    <div class="widget-content">
	                        <div class="padd">
								<div class="col-md-12">
									<div class="form-group">
										<div class="col-lg-12">
											<textarea id="investigations" rows="4" cols="50" class="form-control col-md-6" ></textarea>
										</div>
									</div>
								</div>
							</div>
	                    ...
	                    <div class="widget-content">
	                        <div class="padd">
								<div class="col-md-12">
									<div class="form-group">
										<div class="col-lg-12">
											<textarea id="findings" rows="4" cols="50" class="form-control col-md-6" >'.$findings.'</textarea>
										</div>
									</div>
								</div>
							</div>
	                    ...
	                    <div class="widget-content">
	                        <div class="padd">
								<div class="col-md-12">
									<div class="form-group">
										<div class="col-lg-12">
											<textarea id="findings" rows="4" cols="50" class="form-control col-md-6" ></textarea>
										</div>
									</div>
								</div>
							</div>
	                    ...
	                    <div class="widget-content">
	                        <div class="padd">
								<div class="col-md-12">
									<div class="form-group">
										<div class="col-lg-12">
											<textarea id="plan" rows="4" cols="50" class="form-control col-md-6" >'.$plan_description.'</textarea>
										</div>
									</div>
								</div>
							</div>
	                    ...
	                    <div class="widget-content">
	                        <div class="padd">
								<div class="col-md-12">
									<div class="form-group">
										<div class="col-lg-12">
											<textarea id="plan" rows="4" cols="50" class="form-control col-md-6" ></textarea>
										</div>
									</div>
								</div>
							</div>
	                    ...
	                    <div class="widget-content">
	                        <div class="padd">
								<div class="col-md-12">
									<div class="form-group">
										<div class="col-lg-12">
											<textarea id="rx" rows="4" cols="50" class="form-control col-md-6" >'.$rx_description.'</textarea>
										</div>
									</div>
								</div>
							</div>
	                    ...
	                    <div class="widget-content">
	                        <div class="padd">
								<div class="col-md-12">
									<div class="form-group">
										<div class="col-lg-12">
											<textarea id="rx" rows="4" cols="50" class="form-control col-md-6" ></textarea>
										</div>
									</div>
								</div>
							</div>
	                    ...
	                    <div class="widget-content">
	                        <div class="padd">
								<div class="col-md-12">
									<div class="form-group">
										<div class="col-lg-12">
											<textarea id="tca" rows="4" cols="50" class="form-control col-md-6" >'.$tca_description.'</textarea>
										</div>
									</div>
								</div>
							</div>
	                    ...
	                    <div class="widget-content">
	                        <div class="padd">
								<div class="col-md-12">
									<div class="form-group">
										<div class="col-lg-12">
											<textarea id="tca" rows="4" cols="50" class="form-control col-md-6" ></textarea>
										</div>
									</div>
								</div>
